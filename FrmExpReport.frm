VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} FrmExpReport 
   Caption         =   "Report Settings"
   ClientHeight    =   3465
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   3915
   OleObjectBlob   =   "FrmExpReport.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "FrmExpReport"
...
Private Sub BtnRun_Click()
    If Validation Then
        ModReports.ExpQualReport Watch, Period
        Unload Me
    Else
